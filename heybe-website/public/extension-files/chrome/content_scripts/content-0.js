(()=>{"use strict";var e={},t={};function o(n){var r=t[n];if(void 0!==r)return r.exports;var i=t[n]={exports:{}};return e[n](i,i.exports,o),i.exports}o.rv=()=>"1.4.11",o.ruid="bundler=rspack@1.4.11",window.CrossBrowserStorage=new class{constructor(){this.storageKey="tum_listem_user_id",this.isExtension="undefined"!=typeof chrome&&chrome.runtime&&chrome.runtime.id,this.browserType=this.detectBrowser()}detectBrowser(){if("undefined"!=typeof chrome&&chrome.runtime)return chrome.runtime.getManifest&&chrome.runtime.getManifest().browser_specific_settings?"firefox":"chrome";return"unknown"}getStorageAPI(){return"firefox"===this.browserType?{set:e=>browser.storage.local.set(e),get:e=>browser.storage.local.get(e),remove:e=>browser.storage.local.remove(e),clear:()=>browser.storage.local.clear()}:{set:e=>chrome.storage.local.set(e),get:e=>chrome.storage.local.get(e),remove:e=>chrome.storage.local.remove(e),clear:()=>chrome.storage.local.clear()}}async setUserId(e){try{if(this.isExtension){let t=this.getStorageAPI();await t.set({[this.storageKey]:e}),console.log(`\u{2705} [${this.browserType.toUpperCase()}] UUID kaydedildi:`,e),this.notifyWebSite(e)}else"undefined"!=typeof chrome&&chrome.runtime&&chrome.runtime.id||(localStorage.setItem(this.storageKey,e),console.log("✅ [Web Site] UUID localStorage'a yazıldı (extension yok):",e));return!0}catch(e){return console.error(`\u{274C} [${this.browserType.toUpperCase()}] UUID yazma hatas\u{131}:`,e),!1}}async getUserId(){try{if(!this.isExtension)return await this.requestFromExtension();{let e=this.getStorageAPI(),t=(await e.get([this.storageKey]))[this.storageKey];return console.log(`\u{2705} [${this.browserType.toUpperCase()}] UUID okundu:`,t),t}}catch(e){return console.error(`\u{274C} [${this.browserType.toUpperCase()}] UUID okuma hatas\u{131}:`,e),null}}async requestFromExtension(){try{return console.log("\uD83D\uDD04 [Web Site] Extension'dan UUID isteniyor..."),await new Promise((e,t)=>{("undefined"!=typeof browser?browser.runtime:chrome.runtime).sendMessage({action:"getUserId"},o=>{let n="undefined"!=typeof browser?browser.runtime.lastError:chrome.runtime.lastError;if(n){console.log("❌ [Web Site] Extension mesaj hatası:",n),t(Error("Extension bulunamadı"));return}o&&o.userId?(console.log("✅ [Web Site] Extension'dan UUID alındı:",o.userId),e(o.userId)):(console.log("❌ [Web Site] UUID bulunamadı"),t(Error("UUID bulunamadı")))})})}catch(t){console.log("❌ [Web Site] Extension'dan UUID alma hatası:",t);let e=localStorage.getItem(this.storageKey);if(e)return console.log("\uD83D\uDD04 [Web Site] Fallback: localStorage'dan UUID okundu:",e),e;return null}}notifyWebSite(e){try{window.dispatchEvent(new CustomEvent("extensionUserIdSet",{detail:{userId:e,browser:this.browserType}})),console.log(`\u{2705} [${this.browserType.toUpperCase()}] Web sitesine event g\xf6nderildi:`,e)}catch(e){console.error(`\u{274C} [${this.browserType.toUpperCase()}] Event g\xf6nderme hatas\u{131}:`,e)}}async deleteUserId(){try{if(this.isExtension){let e=this.getStorageAPI();await e.remove([this.storageKey]),console.log(`\u{2705} [${this.browserType.toUpperCase()}] UUID silindi`)}else localStorage.removeItem(this.storageKey),console.log("✅ [Web Site] UUID localStorage'dan silindi");return!0}catch(e){return console.error(`\u{274C} [${this.browserType.toUpperCase()}] UUID silme hatas\u{131}:`,e),!1}}async debugStorage(){try{if(this.isExtension){let e=this.getStorageAPI(),t=await e.get(null);return console.log(`\u{1F4CA} [${this.browserType.toUpperCase()}] T\xfcm storage:`,t),t}{let e={};for(let t=0;t<localStorage.length;t++){let o=localStorage.key(t);e[o]=localStorage.getItem(o)}return console.log("\uD83D\uDCCA [Web Site] localStorage:",e),e}}catch(e){return console.error(`\u{274C} [${this.browserType.toUpperCase()}] Storage Debug Hatas\u{131}:`,e),{}}}getBrowserInfo(){return{type:this.browserType,isExtension:this.isExtension,storageKey:this.storageKey}}},"undefined"!=typeof chrome&&chrome.runtime&&chrome.runtime.id&&("undefined"!=typeof browser?browser.runtime:chrome.runtime).onMessage.addListener((e,t,o)=>"getUserId"===e.action?(window.CrossBrowserStorage.getUserId().then(e=>{o({userId:e})}),!0):"getBrowserInfo"===e.action?(o(window.CrossBrowserStorage.getBrowserInfo()),!1):void 0),console.log("\uD83D\uDE80 Cross-Browser Storage Helper y\xfcklendi:",window.CrossBrowserStorage.getBrowserInfo()),(()=>{async function e(t,o,n=null){return new Promise((e,r)=>{chrome.runtime.sendMessage({action:"apiRequest",method:t,endpoint:o,data:n},t=>{if(chrome.runtime.lastError)return void r(Error(chrome.runtime.lastError.message));t&&t.success?e(t.data):r(Error(t?.error||"API isteği başarısız"))})})}async function t(){try{let e=await new Promise((e,t)=>{chrome.runtime.sendMessage({action:"getActiveUUID"},o=>{if(chrome.runtime.lastError)return void t(Error("Extension bulunamadı"));o&&o.uuid?e(o):t(Error("UUID bulunamadı"))})});o(e)}catch(e){}}function o(e){try{window.dispatchEvent(new CustomEvent("extensionActiveUUIDSet",{detail:{uuid:e.uuid,type:e.type}})),window.EXTENSION_ACTIVE_UUID=e.uuid,window.EXTENSION_UUID_TYPE=e.type,window.EXTENSION_UUID_TIMESTAMP=Date.now()}catch(e){}}async function n(e,t="guest"){try{console.log("\uD83D\uDCE4 [Content Script] UUID extension'a g\xf6nderiliyor:",{uuid:e,type:t});let o="permanent"===t?"setPermanentUUID":"setGuestUUID";return await new Promise((n,r)=>{chrome.runtime.sendMessage({action:o,uuid:e},o=>{if(chrome.runtime.lastError){console.log("❌ [Content Script] Extension mesaj hatası:",chrome.runtime.lastError),r(Error("Extension bulunamadı"));return}o&&o.success?(console.log("✅ [Content Script] UUID extension'a g\xf6nderildi:",{uuid:e,type:t}),n(!0)):r(Error("UUID kaydedilemedi"))})})}catch(e){return!1}}let r=!1,i=null;async function s(t){try{if(r)return console.log("⏳ [Content Script] Kayıt işlemi devam ediyor, \xfcr\xfcn bekletiliyor...","isRegistrationInProgress:",r),i=t,l("Kayıt işlemi tamamlandıktan sonra \xfcr\xfcn eklenecek!"),!0;let o=await new Promise((e,t)=>{chrome.runtime.sendMessage({action:"getActiveUUID"},o=>{if(chrome.runtime.lastError){console.log("❌ [Content Script] Extension mesaj hatası:",chrome.runtime.lastError),t(Error("Extension bulunamadı"));return}o&&o.uuid?e(o):t(Error("UUID bulunamadı"))})});if("guest"===o.type){if(console.log("\uD83D\uDC64 [Content Script] Guest kullanıcı, uyarı popup'ı a\xe7ılıyor..."),i=t,console.log("\uD83D\uDCE6 [Content Script] \xdcr\xfcn bekletiliyor:",i),!await new Promise(t=>{let o=document.createElement("div");o.style.cssText=`
                ...
                `,g.textContent="Giriş Yap",g.onmouseover=()=>g.style.background="#1d4ed8",g.onmouseout=()=>g.style.background="#2563eb",g.onclick=()=>{document.body.removeChild(o),r=!0,console.log("\uD83D\uDD10 [Content Script] Giriş Yap butonuna tıklandı, isRegistrationInProgress = true"),new Promise(t=>{let o=document.createElement("div");o.style.cssText=`
      position: fixed;
      top: 0;
      left: 0;
      width: 100%;
    ...
    `;let s=document.createElement("h3");s.style.cssText=`
      ...
      margin: 0 0 24px;
      text-align: center;
    `,s.textContent="Giriş Yap / Kayıt Ol";let l=document.createElement("form");l.style.cssText=`
      display: flex;
    ...
    `;let d=document.createElement("label");d.style.cssText=`
      ...
      color: #374151;
      margin-bottom: 4px;
    `,d.textContent="E-posta";let c=document.createElement("input");c.type="email",c.required=!0,c.style.cssText=`
      padding: 12px 16px;
      ...
      outline: none;
    `,c.placeholder="ornek@email.com",c.onfocus=()=>c.style.borderColor="#2563eb",c.onblur=()=>c.style.borderColor="#d1d5db";let u=document.createElement("label");u.style.cssText=`
      font-size: 14px;
      font-weight: 500;
      color: #374151;
      margin-bottom: 4px;
    `,u.textContent="Şifre";let p=document.createElement("input");p.type="password",p.required=!0,p.style.cssText=`
      padding: 12px 16px;
      border: 1px solid #d1d5db;
      border-radius: 8px;
      font-size: 14px;
      transition: border-color 0.2s;
      outline: none;
    `,p.placeholder="Şifrenizi girin",p.onfocus=()=>p.style.borderColor="#2563eb",p.onblur=()=>p.style.borderColor="#d1d5db";let m=document.createElement("div");m.style.cssText=`
      color: #dc2626;
      font-size: 14px;
      text-align: center;
      min-height: 20px;
    ...
    `;let g=document.createElement("div");g.style.cssText=`
      ...
      gap: 12px;
      margin-top: 8px;
    `;let y=document.createElement("button");y.type="button",y.style.cssText=`
      flex: 1;
      background: #2563eb;
      color: white;
      border: none;
      ...
      cursor: pointer;
      transition: background 0.2s;
    `,y.textContent="Giriş Yap",y.onmouseover=()=>y.style.background="#1d4ed8",y.onmouseout=()=>y.style.background="#2563eb";let b=document.createElement("button");b.type="button",b.style.cssText=`
      flex: 1;
      background: #059669;
      color: white;
      border: none;
      ...
      cursor: pointer;
      transition: background 0.2s;
    `,b.textContent="Kayıt Ol",b.onmouseover=()=>b.style.background="#047857",b.onmouseout=()=>b.style.background="#059669";let h=document.createElement("button");h.type="button",h.style.cssText=`
      width: 100%;
      background: #f3f4f6;
      color: #374151;
      border: none;
      ...
      transition: background 0.2s;
      margin-top: 12px;
    `,h.textContent="İptal",h.onmouseover=()=>h.style.background="#e5e7eb",h.onmouseout=()=>h.style.background="#f3f4f6",h.onclick=()=>{document.body.removeChild(o),t(!1)},y.onclick=async()=>{let i=c.value.trim(),s=p.value;if(!i||!s){m.textContent="L\xfctfen email ve şifre girin",m.style.display="block";return}y.textContent="Giriş yapılıyor...",y.disabled=!0,b.disabled=!0,m.style.display="none",r=!0;try{let l=await new Promise(e=>{chrome.storage.local.get(["tum_listem_guest_uuid"],t=>{e(t.tum_listem_guest_uuid)})}),d=await e("POST","login",{email:i,password:s,guest_user_id:l||null});d&&d.uuid?(console.log("✅ [API Response] Login başarılı:",d),await n(d.uuid,"permanent"),console.log("✅ [Content Script] Login başarılı, permanent UUID set edildi:",d.uuid),document.body.removeChild(o),r=!1,await a(d.uuid),t(!0)):(console.log("❌ [API Response] Login başarısız:",d),m.textContent=d.error||"Giriş başarısız",m.style.display="block",y.textContent="Giriş Yap",y.disabled=!1,b.disabled=!1,r=!1)}catch(e){console.log("❌ [API Error] Login hatası:",e.message),e.message&&e.message.includes("400")?m.textContent="Ge\xe7erli bir email adresi girin":e.message&&e.message.includes("401")?m.textContent="Email veya şifre hatalı":m.textContent="Bağlantı hatası",m.style.display="block",y.textContent="Giriş Yap",y.disabled=!1,b.disabled=!1,r=!1}},b.onclick=async()=>{let t=c.value.trim(),i=p.value;if(!t||!i){m.textContent="L\xfctfen email ve şifre girin",m.style.display="block";return}if(i.length<6){m.textContent="Şifre en az 6 karakter olmalı",m.style.display="block";return}y.disabled=!0,b.textContent="Kayıt yapılıyor...",b.disabled=!0,m.style.display="none";try{let s=await new Promise(e=>{chrome.storage.local.get(["tum_listem_guest_uuid"],t=>{e(t.tum_listem_guest_uuid)})}),l=await e("POST","register",{email:t,password:i,guest_user_id:s||null});if(l&&l.uuid)return console.log("✅ [API Response] Register başarılı:",l),await n(l.uuid,"permanent"),console.log("✅ [Content Script] Kayıt başarılı, permanent UUID set edildi:",l.uuid),document.body.removeChild(o),r=!1,await a(l.uuid),!0;if(!(l&&l.error&&l.error.includes("409")))return console.log("❌ [API Response] Register başarısız:",l),m.textContent=l.error||"Kayıt başarısız",m.style.display="block",y.disabled=!1,b.textContent="Kayıt Ol",b.disabled=!1,r=!1,!1;console.log("\uD83D\uDD04 [API Response] Kullanıcı zaten var, login deneniyor:",l),console.log("\uD83D\uDD04 [Content Script] Kullanıcı zaten kayıtlı, login deneniyor...");try{let l=await e("POST","login",{email:t,password:i,guest_user_id:s||null});if(l&&l.uuid)return console.log("✅ [API Response] Auto-login başarılı:",l),await n(l.uuid,"permanent"),console.log("✅ [Content Script] Login başarılı, permanent UUID set edildi:",l.uuid),document.body.removeChild(o),r=!1,await a(l.uuid),!0;return console.log("❌ [API Response] Auto-login başarısız:",l),m.textContent="Email veya şifre hatalı",m.style.display="block",y.disabled=!1,b.textContent="Kayıt Ol",b.disabled=!1,r=!1,!1}catch(e){return console.log("❌ [API Error] Auto-login hatası:",e.message),m.textContent="Email veya şifre hatalı",m.style.display="block",y.disabled=!1,b.textContent="Kayıt Ol",b.disabled=!1,r=!1,!1}}catch(e){return console.log("❌ [API Error] Register hatası:",e.message),e.message&&e.message.includes("400")?m.textContent="Ge\xe7erli bir email adresi girin":e.message&&e.message.includes("409")?m.textContent="Bu kullanıcı zaten var":e.message&&e.message.includes("401")?m.textContent="Email veya şifre hatalı":m.textContent="Bağlantı hatası",m.style.display="block",y.disabled=!1,b.textContent="Kayıt Ol",b.disabled=!1,r=!1,!1}},l.appendChild(d),l.appendChild(c),l.appendChild(u),l.appendChild(p),l.appendChild(m),g.appendChild(y),g.appendChild(b),l.appendChild(g),l.appendChild(h),i.appendChild(s),i.appendChild(l),o.appendChild(i),document.body.appendChild(o),c.focus(),o.onclick=e=>{e.target===o&&(document.body.removeChild(o),t(!1))}}).then(e=>{t(e)})};let y=document.createElement("button");y.style.cssText=`
                  flex: 1;
                  background: #f3f4f6;
                  color: #374151;
                  border: none;
