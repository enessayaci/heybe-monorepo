...
function AppContent() {
  ...
  return (
    <div className="relative">
      <Loader show={isLoading} size={80} fullScreen></Loader>
      <SidebarProvider>
        <AppSidebar
        ...
        <Dialog open={isInstallModalOpen} onOpenChange={setIsInstallModalOpen}>
          <DialogContent
            ...
            className="sm:max-w-3xl bg-white z-50 h-[calc(100vh-100px)] flex flex-col p-0 overflow-hidden"
          >
            <DialogHeader className="relative shrink-0 px-6 py-4 border-b bg-white">
              ...
              <DialogClose className="absolute top-2 end-2" asChild>
                <Button
                  type="button"
                  size="icon"
                  variant="danger"
